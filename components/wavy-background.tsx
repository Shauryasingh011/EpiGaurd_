...
class Particle {
    ...
    draw(ctx: CanvasRenderingContext2D) {
        ctx.beginPath()
        ctx.fillStyle = "rgba(191, 219, 254, 0.34)"
...
export const WavyBackground = () => {
        ...
        if (context && canvasRef.current) {
            ...
            const render = () => {
                ...
                for (let i = 0; i < 5; i++) {
                    ...
                    drawWave(yOffset, amplitude, frequency, phase + i, `rgba(99, 102, 241, ${0.15 - i * 0.01})`);
                }
                ...
                for (let i = 0; i < 5; i++) {
                    ...
                    drawWave(yOffset, amplitude, frequency, phase + i + 2, `rgba(74, 222, 128, ${0.085 - i * 0.01})`);
                }
    ...
    return <canvas ref={canvasRef} className="fixed inset-0 pointer-events-none z-0 blur-[2px] opacity-90" />
}
